...
class Player(models.Model):
    ...
    runs = models.PositiveIntegerField(null=True, blank=True)
    century = models.PositiveIntegerField(null=True, blank=True)
    ...
    wickets = models.PositiveIntegerField(null=True, blank=True)
